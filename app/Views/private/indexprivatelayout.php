...
<body>
  ...
  <?= $this->renderSection('navbarPrivate') ?>
  <?= $this->renderSection('receiptsDashboard') ?>
  <?= $this->renderSection('expiredsReceipts') ?>
  <?= $this->renderSection('balance') ?>
  <?= $this->renderSection('transactions') ?>
  <?= $this->renderSection('pendingReceipts') ?>
  <?= $this->renderSection('footerPrivate') ?>
</body>
</html>