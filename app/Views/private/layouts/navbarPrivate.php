      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <ul class="navbar-nav justify-content-end">
            <li class="nav-item">
              <a class="nav-link active shadow-link rounded-1" href="<?= base_url("/private/dashboard")?>">Inicio</a>
            </li>
            <li class="nav-item">
              <a class="nav-link active shadow-link rounded-1" href="<?= base_url("/private/payreceipts")?>">Pagar Recibos</a>
            </li>
            <li class="nav-item">
