...
<div class="d-flex justify-content-center align-items-center vh-100">
  <form action="<?php echo base_url('login'); ?>" method="POST">
    <div id = "form" class="back-cc bg-white p-5 rounded-5 text-secondary shadow" style="width: 24rem;">
      ...
      <div class="text-center fs-5 fw-regular font-sing">Iniciar Sesión mod</div>
      ...
      <div class="input-group mt-2">
        <div class="input-group-text text-primary">
          ...
          <input class="form-control bg-light" name="user" id="user" type="text" placeholder="Nombre de usuario"/>
      </div>
      ...
      <div class="input-group mt-4">
        <div class="input-group-text">
          ...
          <input class="form-control bg-light" name="psw" type="password" placeholder="Contraseña"/>
      </div>
        
        <div class="d-flex gap-1 justify-content-center mt-3">
          <div>¿No tienes cuenta? &nbsp;</div>
          <a href="<?= base_url('registro') ?>" class="text-decoration-none fw-semibold" >Registrate aqui!</a>
        </div>

        <div class="d-grid gap-2 mt-3 mb-3">

          <button class="btn btn-primary text-white" type="submit">Iniciar sesion</button>
